...
function check(){
    ...
    correct_answers+=this_time_correct_answers/2;
    ...
    if(current_progress==0) html_table_question.innerHTML = "Metal Reactivity Series (Starting from the most reactive metal)";
...
function question(){
    current_progress ++;
    if(current_progress==0) html_question.innerHTML = "Metal Reactivity Series (Starting from the most reactive metal)";
