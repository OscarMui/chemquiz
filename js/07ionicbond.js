...
function check(){
    ...
    let answer2 = iongetbondstring(formula1,charge1,cation_needbracket[cation_number],formula2,charge2,anion_needbracket[anion_number]);
    ...
    html_table_question.innerHTML = cation_formula[cation_number] + " and " + anion_formula[anion_number];
    html_correct.innerHTML = answer1 + "," + answer2;
...
function question(){
    ...
    html_question.innerHTML = cation_formula[cation_number] + " and " + anion_formula[anion_number];
    html_input1.value = "";
    html_input2.value = "";
    html_input1.focus();
}
